...
export default async function handler(req, res) {
    ...
    const { ParseBigNum, sendTransaction, ReadContract,  } = await useContractSolana.default();
    const {ReadContractByQuery,getQuery,contract,api,signerAddress}= await useContract.default();

...
String domain = "https://wavedata-blockchain-for-good.onrender.com";
  ...
  List<ChartData> chartDataBlood = [
    ChartData("1/11/2024", 23),
    ChartData("2/11/2024", 55),
    ChartData("3/11/2024", 76),
    ChartData("4/11/2024", 33),
    ChartData("5/11/2024", 55),
    ChartData("6/11/2024", 99),
    ChartData("7/11/2024", 88),
    ChartData("8/11/2024", 87)
  ];
  List<ChartData> chartDataSleep = [
    ChartData("1/11/2024", 445),
    ChartData("2/11/2024", 656),
    ChartData("3/11/2024", 443),
    ChartData("4/11/2024", 787),
    ChartData("5/11/2024", 834),
    ChartData("6/11/2024", 590),
    ChartData("7/11/2024", 776),
    ChartData("8/11/2024", 589)
  ];
  List<ChartData> chartDataCalories = [
    ChartData("1/11/2024", 67),
    ChartData("2/11/2024", 78),
    ChartData("3/11/2024", 89),
    ChartData("4/11/2024", 98),
    ChartData("5/11/2024", 78),
    ChartData("6/11/2024", 90),
    ChartData("7/11/2024", 78),
    ChartData("8/11/2024", 89)
  ];
  List<ChartData> chartDataSteps = [
    ChartData("1/11/2024", 76),
    ChartData("2/11/2024", 54),
    ChartData("3/11/2024", 34),
    ChartData("4/11/2024", 90),
    ChartData("5/11/2024", 67),
    ChartData("6/11/2024", 54),
    ChartData("7/11/2024", 67),
    ChartData("8/11/2024", 45)
  ];
